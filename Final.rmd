...
Looking a the bar chart we can observe that the vaccine is not working for these group the Drug-user. Looks like 85% of the drug-user that took the vaccine got sick with covid10 and those that took the placebo only about 18% of them gor covid19. so we can conclude that the vaccine was ineffective  for these group they are better of with the placebo.
